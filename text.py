...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[TIME] = Text("0".zfill(8), WHITE, 20*TILEWIDTH, 35*TILEHEIGHT, size)
        self.addText("SCORE", WHITE, 0, 0, size)
        self.addText("LEVEL", WHITE, 23*TILEWIDTH, 0, size)
        self.addText("TIME", WHITE, 24*TILEWIDTH, 36*TILEHEIGHT,size)
    ...
    def updateTime(self, dt):
        self.updateText(TIME, str(dt).zfill(8))
